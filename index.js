...
function filterStudentsByGrade(students, grade) {
  //Виведеме в консоль критичну помилку з текстом якщо ви бачите це повідомлення
  // завдання 1 виконано не правильно
  // Очищення консолі перед виведенням
  // Виведемо повідомлення для відстеження роботи програми з
  // текстом "Завдання: 1 =============================="
  // Відфільтруємо тільки тих студентів оцінка яких співпадає з grade
  // За допомогою перебору масиву виведемо повідомлення для відстеження роботи
  // програми з іменем кожного студента, який має необхідну оцінку
...
function warnAboutMaxArrayLength(arr, maxLength) {
  ...
  // потенційну проблеми з текстом: "Увага! Довжина масиву перевищує максимально допустиму!".
 ...
 * Вона використовує `console.assert()` для перевірки того, чи обидва
 * масиви є однаковими.
...
function buildMatrix(size) {
  ...
  // Цикл всередені циклу для заповнення колонок матриці,
  // лічильник j має бути від 0 до розміру матриці.
...
// Завдання 6
/**
 * Функція `traceBackward` виводить числа від заданого до 1
 * у зворотному порядку, використовуючи рекурсію.
 *
 *  n - стартове число.
 */
...
function validateUserInput(userInput) {
  // Перевіремо умову наявності імені користувача, якщо воно відсутнє
  // виводимо "Помилка: ім'я користувача відсутнє!"
  // Перевіремо умову наявності паролю, якщо він відсутній виводимо
  // "Помилка: пароль відсутній!"
  // Перевірка довжини паролю чи менше вона ніж 8,якщо ні виводимо повідомлення про
  //потенційну проблему з текстом "Попередження: пароль має бути довшим за 8 символів!"
...
// Завдання 9
/**
 * Функція `calculateTotalPrice` обчислює загальну вартість товарів
 * та логує час виконання.
...
// Завдання 10
/**
 * Функція `countVowelsAndConsonants` пораховує кількість голосних
 * і приголосних літер у слові.
 *
...
function countVowelsAndConsonants(word) {
  ...
  // виводимио лічильник голосних, інакше приголосних
  // Скидаємо лічильники
  let vowels = "aeiou";
